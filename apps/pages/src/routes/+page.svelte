...
<p>
	This page tracks where new Durable Objects are created; for example, when you loaded this page from  <span class="font-bold">{data.city}</span>, a worker in  <span class="font-bold">{data.worker}</span> created a durable object in  <span class="font-bold">{data.durable}</span>.
</p>
<p>
...
<p>
	Data displayed on this site is updated every 5 minutes. Historical data may be available via the API in the future. Discussion of coming features is on <Anchor class="text-sky-500 hover:text-sky-300" target="https://discord.gg/cloudflaredev">the Discord</Anchor>.
</p>
<p>
